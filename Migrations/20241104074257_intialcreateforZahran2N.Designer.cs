...
namespace momken_backend.Migrations
{
    ...
    [Migration("20241104074257_intialcreateforZahran2N")]
    partial class intialcreateforZahran2N
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("momken_backend.Models.PartnerStoreType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("momken_backend.Models.Zahran.Categories", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("momken_backend.Models.PartnerStore", b =>
                {
                    ...
                    b.HasOne("momken_backend.Models.PartnerStoreSubType", "SubType")
                        .WithMany()
                        .HasForeignKey("SubTypeId");

                    b.HasOne("momken_backend.Models.PartnerStoreType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("momken_backend.Models.Zahran.Categories", "category")
                        .WithMany("PartnerStore")
